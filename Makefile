...
SRC = ./srcs/main.c ./gnl/get_next_line.c  ./parsing/read_map.c ./parsing/utils.c ./parsing/check_func.c \
	...
	./ray-casting/get_intersection.c ./game_utils/game_init_utils.c ./game_randring/front_view_draw.c \
	./game_randring/wall_textures.c ./parsing/check_func2.c ./parsing/store_func2.c
OBJ = $(SRC:.c=.o)
